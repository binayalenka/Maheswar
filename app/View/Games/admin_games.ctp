	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">        
                    <div class="inner-page-title">
                        <h2>Games Listing</h2>
                        <a href="<?php echo HTTP_ROOT.'admin/games/add_game'; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:-10px;">Add Game</a>
                    ...
                    <div class="search">
                        <h2>Search</h2>
                            <?php echo $this->Form->create('Game',array('id'=>'searchGame')); ?>
                                <div class="search_contents">
                                     <label class="desc" >Select Option</label>
                                     <?php echo $this->Form->input('type',array('type'=>'select','id'=>'text_type','div'=>false, 'style'=>'width:148px; padding:4px; border:1px solid #abadb3;' ,'label'=>false,'class'=>'field text full required','options'=>array(''=>'Select','name'=>'Game Name'))); ?>
                                 </div>
                                 <div class="search_contents"> 
                               ...
                               <div class="search_contents" style="margin-top:19px;">                        
                                    <?php echo $this->Form->submit('Search',array('div'=>false,'label'=>false,'id'=>'searchGameRecord','class'=>'field text full required txtts_inproperty')); ?>

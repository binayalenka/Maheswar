	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">        
                    <div class="inner-page-title">
                        ...
                        <a href="<?php echo HTTP_ROOT.'admin/games/add_category'; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:-10px;">Add Category</a>
                    ...
                    <div class="search">
                        <h2>Search</h2>
                        <?php echo $this->Form->create('category',array('id'=>'searchCategory')); ?>
                            <div class="search_contents">
                                 <label class="desc" >Select Option</label>
                                 <?php echo $this->Form->input('type',array('type'=>'select','id'=>'text_type','div'=>false, 'style'=>'width:148px; padding:4px; border:1px solid #abadb3;' ,'label'=>false,'class'=>'field text full required','options'=>array(''=>'Select','name'=>'Category Name'))); ?>
                            </div>
                            <div class="search_contents"> 
                            ...
                            <div class="search_contents" style="margin-top:19px;">                        
                                <?php echo $this->Form->submit('Search',array('div'=>false,'label'=>false,'id'=>'searchCategoryRecord','class'=>'field text full required txtts_inproperty')); ?>

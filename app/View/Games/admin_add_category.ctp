				...
				<div class="column-content-box">
                    ...
                    <ul>
						...
						<li>
							...
							<div>
								<?php echo $this->Form->input('status',array('type'=>'select','div'=>false,'label'=>false,'class'=>'text full field required','options'=>array('1'=>'Active','0'=>'Inactive'))); ?> 
								<p class="tutor-add-Error" id="err_status"><?php if(isset($error['status'][0])) echo $error['status'][0]; ?>  </p>   
							</div>
						</li> 
                        <li>

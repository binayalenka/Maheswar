<div id="page-header-wrapper">
    ...
    <ul id="navigation">
        ...
        <li><a href="#">Tags</a>
            <ul>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/tags/add_tag">Create New Tag</a>
                </li>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/tags/listing_tags">Listing of Tags</a>
                </li>
		<li>
                    <a href="<?php echo HTTP_ROOT;?>admin/pages/listing_pages">Listing of Pages</a>
                </li>
            </ul>
        </li>
        <li><a href="#">Games</a>
            <ul>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/games/add_category">Create Game Category</a>
                </li>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/games/categories">Listing of Game Categories</a>
                </li>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/games/add_game">Create New Game</a>
                </li>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/games/games">Listing of Games</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/users/game_admins">Game Admin</a>
                </li>
                <li>
                    <a href="<?php echo HTTP_ROOT;?>admin/users/game_users">Game Users</a>
                </li>
            </ul>						
